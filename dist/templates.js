angular.module('shares').run(['$templateCache', function($templateCache) {
  'use strict';

  $templateCache.put('_change-indicator.html',
    "\n" +
    "<style>\n" +
    "    change-indicator {\n" +
    "        float: right;\n" +
  ...
  $templateCache.put('_md-card-image-overlay.html',
  ...
  $templateCache.put('_md-card-image-overlay.view.html',
    "<md-card ng-cloak id=\"md-card\">\n" +
    "\n" +
    "    <div id=\"md-card-image\" style=\"position: relative\">\n" +
    "\n" +
  ...
  $templateCache.put('_md-card-mred.view.html',
  ...
  $templateCache.put('_md-card-redfin.html',
    "<md-card class=\"md-card\">\n" +
    "    <div class= \"site-header\">\n" +
    "        <!--<div id= \"md-card-image\"></div>-->\n" +
    "        <div class=\"redfin-logo\"></div>\n" +
    "        <!--<i class=\"mdi md-accent mdi-share-variant\"></i>-->\n" +
    "        <a href=\"{{listing.subjectUrl}}\" target=\"_blank\">\n" +
    "        <i class=\"mdi md-accent mdi-link\"></i>\n" +
    "            </a>\n" +
    "    </div>\n" +
    "    <div layout= \"row\">\n" +
    "        <div flex class= \"left\">\n" +
    ...
    "                <span><b>{{listing.listing_ts | makeDaysOn}}</b></span>\n" +
    "            </div>\n" +
    "\n" +
    "\n" +
    "\n" +
    ...
    "                <span ng-show=\"listing.listing_views_todayCnt\"><b>{{listing.listing_views_todayCnt}}</b></span>\n" +
    "\n" +
    "                <span ng-show=\"!listing.listing_views_todayCnt\"><b>*</b></span>\n" +
    "            </div>\n" +
    "            <div>\n" +
    "\n" +
    "                <label>7-day views</label>\n" +
    "\n" +
    "                <span ng-show=\"listing.listing_views_sevenDayCnt\"><b>{{listing.listing_views_sevenDayCnt}}</b></span>\n" +
    "\n" +
    "                <span ng-show=\"!listing.listing_views_sevenDayCnt\"><b>*</b></span>\n" +
    "\n" +
    "            </div>\n" +
    "\n" +
    "            <div>\n" +
    ...
    "\n" +
    "                <span ng-show=\"listing.listing_views_thirtyDayCnt\"><b>{{listing.listing_views_thirtyDayCnt}}</b></span>\n" +
    "\n" +
    "                <span ng-show=\"!listing.listing_views_thirtyDayCnt\"><b>*</b></span>\n" +
    "\n" +
    "\n" +
    "            </div>\n" +
    "            <div>\n" +
    ...
    "                <span><b>{{listing.listing_prefs_favoritesCnt}}</b></span>\n" +
    "            </div>\n" +
    "            <!--<div>-->\n" +
  ...
  $templateCache.put('_md-card-redfin.view.html',
    "<md-card class=\"md-card  site-summary-card\">\n" +
    "    <div class=\"site-header\">\n" +
    "        <!--<div id= \"md-card-image\"></div>-->\n" +
    "        <div class=\"redfin-logo\"></div>\n" +
  ...
  $templateCache.put('_md-card-sentri-login.view.html',
    "<div>\n" +
  ...
  $templateCache.put('_md-card-sentrilock.view.html',
    "<style>\n" +
    " card-header {\n" +
    "    width: 100%;\n" +
    ...
    "      Serial Number  {{vm.sentrilock.LBSerialNumber}}\n" +
    "     </div>\n" +
    "\n" +
    "\n" +
    ...
    "\n" +
    "        <div  ng-bind-html=\"entry.AccessedByName\"></div>\n" +
  ...
  $templateCache.put('_md-card-showing-detail.html',
    "<style>\n" +
    "\n" +
    ...
    "\n" +
    "                </h2>\n" +
    "                <h3 style=\"padding-left: 10px\"> {{showing.contact.name}} wrote ... </h3>\n" +
    "                <span flex></span>\n" +
    ...
    "            </div>\n" +
    "        </md-toolbar>\n" +
    "        <md-dialog-content style=\"max-width:400px;max-height:410px; \">\n" +
    "            <div>\n" +
    ...
    "                <div ng-show='showing.contact.phone && showing.contact.phone.mobile'  class=\"contact-method\">\n" +
    "                    <span class=\"contact-label\">  <md-icon md-svg-src=\"/assets/icons/ic_phone_iphone_black_48px.svg\" aria-label=\"Mobile\"></md-icon> </span>\n" +
    "                    <span class=\"contact-value\">\n" +
    "                    {{showing.contact.phone.mobile}} (Mobile)\n" +
    "                    </span>\n" +
    "                </div>\n" +
    "                <div ng-show='showing.contact.phone && showing.contact.phone.office'  class=\"contact-method\">\n" +
  ...
  $templateCache.put('_md-card-showing-detail.view.html',
    "<style>\n" +
    "    .dialogdemoBasicUsage #popupContainer {\n" +
    "        position: relative;\n" +
    "    }\n" +
  ...
  $templateCache.put('_md-card-showing-summary.html',
    "<style>\n" +
    "    .showing-scroller {\n" +
    "\n" +
    "        max-height: 300px;\n" +
    ...
    "                        stat-model=\"totalCnt\"\n" +
    "                        md-icon=\"mdi-comment-text-outline\">\n" +
    "                </md-card-stat>\n" +
    "            </div>\n" +
    "\n" +
    "            <br>\n" +
    "\n" +
    "            <div>\n" +
    "                <md-card-stat title=\"positive\"\n" +
    "                              stat-model=\"posCnt\"\n" +
    "                              md-icon=\"mdi-comment-plus-outline\"\n" +
    "                              special-class=\"positive-color\">\n" +
    "                </md-card-stat>\n" +
    "            </div>\n" +
    "            <br>\n" +
    "\n" +
    "            <div>\n" +
    "                <md-card-stat title=\"not so positive\"\n" +
    "                              stat-model=\"negCnt\"\n" +
    "                              md-icon=\"mdi-comment-alert-outline\"\n" +
    "                              special-class=\"negative-color\">\n" +
    "\n" +
    "                </md-card-stat>\n" +
    "            </div>\n" +
    "\n" +
    ...
    "            READ FEEDBACK\n" +
    "            <md-icon ng-show='collapsed' class=\"s36\"\n" +
    "                     md-svg-src=\"/assets/icons/ic_expand_more_black_48px.svg\">\n" +
    "            </md-icon>\n" +
    "\n" +
    "            <md-icon ng-show='!collapsed' class=\"s36\"\n" +
    "                     md-svg-src=\"/assets/icons/ic_expand_less_black_48px.svg\">\n" +
    "            </md-icon>\n" +
    "        </md-button>\n" +
    "\n" +
    "    </div>\n" +
    ...
    "\n" +
    "        <md-list-item class=\"md-3-line\" ng-repeat=\"showing in showings\" ng-click=\"show($event, showing)\">\n" +
    "\n" +
    "            <i class=\"mdi mdi-comment-text md-accent  md-avatar s36\">\n" +
    "\n" +
    "            </i>\n" +
    "\n" +
    "            <div class=\"md-list-item-text\">\n" +
    "\n" +
    "                <h3 class=\"order-address\">{{showing.startTime | timeago}} - {{showing.contact.name}}</h3>\n" +
    "\n" +
    "                <h4>{{showing.feedback}}   {{showing.startTime}}\n" +
    "                </h4>\n" +
    "\n" +
    "                <!--<md-button class=\"md-accent\"  ng-click=\"show($event)\">-->\n" +
    "                    <!--dialog-->\n" +
    "\n" +
    "                <!--</md-button>-->\n" +
    "\n" +
  ...
  $templateCache.put('_md-card-site-summary.html',
    "<md-card class=\"md-card\">\n" +
    "\n" +
    "    <div layout=\"row\" layout-align=\"space-around center\" style=\"padding: 10px\">\n" +
    "\n" +
  ...
  $templateCache.put('_md-card-trulia.html',
    "<md-card class=\"md-card\">\n" +
    "    <div class=\"site-header\">\n" +
    ...
    "            <div style=\"border-bottom: 1px solid #eee;\">\n" +
    "\n" +
    "                <label style=\"color: #636075; font-size: 11px;\"><b>Real Estate Trends for {{listing.PostalCode}}</b></label>\n" +
    "            </div>\n" +
    "\n" +
    "            <div>\n" +
  ...
  $templateCache.put('_md-card-trulia.view.html',
    "<md-card class=\"md-card site-summary-card\">\n" +
    "    <div class=\"site-header\">\n" +
    "        <div class=\"trulia-logo\"></div>\n" +
    "       \n" +
  ...
  $templateCache.put('_md-card-zillow.html',
    "\n" +
    "\n" +
    "<md-card class=\"md-card\">\n" +
    "    <div class= \"site-header\">\n" +
    "        <div class=\"zillow-logo\"></div>\n" +
    "     <!--   <img src=\"/assets/logos/zillow_logo_40x189.png\"  class=\"logo\"> -->\n" +
    "        <a href=\"{{listing.subjectUrl}}\" target=\"_blank\">\n" +
    "            <i class=\"mdi md-accent mdi-link\"></i>\n" +
    "        </a>\n" +
    "    </div>\n" +
    ...
    "                    <tr class=\"data-row\">\n" +
    "                        <td class=\"card-data-label\">current value</td>\n" +
    "                        <td class=\"data\">{{listing.est_currentValue |  noFractionCurrency }}\n" +
    "                            <md-icon class=\"negative-color\"\n" +
    "                                     ng-show=\"listing.est_thirtyDayChange < 0\"\n" +
    "                                     md-svg-src=\"/assets/icons/ic_trending_down_black_18px.svg\"></md-icon>\n" +
    "\n" +
    ...
    "                        <td class=\"data\"\n" +
    "                            ng-class=\"listing.est_thirtyDayChange < 0  ? 'negative-color' : ''\">\n" +
    "                            {{listing.est_thirtyDayChange |  noFractionCurrency }}\n" +
    "                        </td>\n" +
    "                    </tr>\n" +
    "\n" +
    "                    <tr class=\"data-row\" ng-show='listing.est_highRange'>\n" +
    "                        <td class=\"card-data-label\">high range</td>\n" +
    "                        <td class=\"data\">{{listing.est_highRange |  noFractionCurrency }}</td>\n" +
    "                    </tr>\n" +
    "                    <tr class=\"data-row\" ng-show='listing.est_lowRange'>\n" +
    "                        <td class=\"card-data-label\">low range</td>\n" +
    "                        <td class=\"data\">{{listing.est_lowRange |  noFractionCurrency }}</td>\n" +
    "                    </tr>\n" +
    "\n" +
    "                    </tbody>\n" +
    "                </div>\n" +
    ...
    "\n" +
    "            <div>\n" +
    "                <md-card-stat ng-show='listing.listing_views_totalCnt' title=\"TOTAL\" stat-model=\"listing.listing_views_totalCnt\">\n" +
    "\n" +
    "                </md-card-stat>\n" +
    "            </div>\n" +
    "\n" +
  ...
  $templateCache.put('_md-card-zillow.view.html',
    "<md-card class=\"md-card site-summary-card\">\n" +
    "    <div class=\"site-header\">\n" +
    "        <div class=\"zillow-logo\"></div>\n" +
    "      \n" +
  ...
  $templateCache.put('_md-showing-summary.html',
    "<!--<div class= \"feedback-header\" ui-sref=\"feedback\">-->\n" +
    "    <!--<h5>Feedback</h5>-->\n" +
    "<!--</div>-->\n" +
    "\n" +
    "<div class=\"site-header\">\n" +
    ...
    "        <md-list-item class=\"md-3-line\" ng-repeat=\"showing in showings\" ng-click=\"show($event, showing)\">\n" +
    "-->\n" +
    "<div ng-repeat=\"showing in showings | maxRecords:4  | groupBy:['potentialOffer']\" ng-click=\"show($event, showing)\">\n" +
    ...
    "            <p> {{showing.feedback}}</p>\n" +
    "</div>\n" +
    "    <div ng-hide=\"showings.length <= 4\" ng-click=\"showMoreFeedback()\">\n" +
    "\n" +
    "        <label><b>Show More</b></label>\n" +
    "        <span> ... </span>\n" +
    "        <p> {{showing.feedback}}</p>\n" +
  ...
  $templateCache.put('_md-showing-summary.view.html',
    "\n" +
    "<md-card>\n" +
    "<div class=\"site-header\">\n" +
    "    <div class=\"showingsdotcom-logo\"></div>\n" +
  ...
  $templateCache.put('_md-stat-summary.view.html',
  ...
  $templateCache.put('md-card-showing-summary.html',
    "<style>\n" +
    "    .showing-scroller {\n" +
    "\n" +
    "        max-height: 300px;\n" +
    ...
    "</style>\n" +
    "\n" +
    "<md-card id=\"md-card site-summary-card\" ng-show=\"showings.length > 0\">\n" +
    "\n" +
    "    <div layout=\"row\" layout-align=\"space-around center\" style=\"padding: 10px\">\n" +
    "\n" +
    "        <div class=\"md-card-left-of-image\">\n" +
  ...
  $templateCache.put('md-card-site-summary.html',
    "<md-card class=\"md-card site-summary-card\">\n" +
    "\n" +
    "    <div layout=\"row\" layout-align=\"space-around center\" style=\"padding: 10px\">\n" +
    "\n" +
